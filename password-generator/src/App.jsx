...
function App() {
  ...
  return (
    <>
      ...
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-48 bg-gray-800 text-teal-600">
        ...
        <div className="flex shadow rounded-2xl overflow-hidden mb-4">
          ...
          <button
            ...
            className="outline-none bg-red-700 text-white px-3 py-0.5 shrink-0 hover:bg-red-900"
          >
            Copy
          </button>
        </div>
